...
def create_matcher(spacy_model = "fr_core_news_lg", nlp:spacy.language.Language = None):
    ...
    passive_rule_2 = [
        ...
        {"DEP": "PUNCT", "OP" : "*"},
        {"TAG":"VERB","MORPH": {"IS_SUPERSET": ["Tense=Past","VerbForm=Part","Voice=Pass"]}, "DEP": "acl","LEMMA": {"NOT_IN" : intransitif_verbs_list}}
    ]
    ...
    passive_rule_5 = [
        {"DEP": "nsubj"},
        {"DEP": "ROOT"},
        {"DEP": "attr", "TAG":"VERB","MORPH": {"IS_SUPERSET": ["Tense=Past","VerbForm=Part","Voice=Pass"]}, "LEMMA":{"NOT_IN" : intransitif_verbs_list}},
        {"DEP": "prep", "TAG":"ADP", "OP":"*"}
    ]
    ...
    matcher.add("passive_rule_2", [passive_rule_2], greedy='LONGEST') # n'exhiste pas en français à priori
    matcher.add("passif_sequencé", [passive_rule_3], greedy='LONGEST')
    matcher.add("passif_impersonel", [passive_rule_4], greedy='LONGEST')
    matcher.add("passive_rule_5", [passive_rule_5], greedy='LONGEST')# n'existe pas en français à priori
